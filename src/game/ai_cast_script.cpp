...
===============
*/
bool AICast_EventMatch_StringEqual( cast_script_event_t *event, const char *eventParm ) {
...
===============
*/
bool AICast_EventMatch_IntInRange( cast_script_event_t *event, const char *eventParm )
{
    // get the cast name
