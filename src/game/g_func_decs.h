...
extern int BG_IndexForString ( const char * token , animStringItem_t * strings , qboolean allowFail ) ;
...
extern qboolean AICast_CheckAttack_real ( cast_state_t * cs , int enemy , bool allowHitWorld ) ;
...
extern bool PM_SlideMove ( qboolean gravity ) ;
