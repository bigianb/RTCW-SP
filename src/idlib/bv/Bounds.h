...
{
	idBounds bounds;
	bounds.FromTransformedBounds( *this, id_vec3_origin, r );
	return bounds;
}

inline idBounds& idBounds::operator*=( const idMat3& r )
{
	this->FromTransformedBounds( *this, id_vec3_origin, r );
	return *this;
}
...
{
	idBounds bounds;
	bounds.FromTransformedBounds( *this, id_vec3_origin, rotation );
	return bounds;
}

inline idBounds& idBounds::RotateSelf( const idMat3& rotation )
{
	FromTransformedBounds( *this, id_vec3_origin, rotation );
	return *this;
}
...
inline int idBounds::GetDimension() const
{
	return 6;
}

inline const float* idBounds::ToFloatPtr() const
{
	return &b[0].x;
}

inline float* idBounds::ToFloatPtr()
{
	return &b[0].x;
}
