...
idRotation idAngles::ToRotation() const
{
	...
	if( pitch == 0.0f )
	{
		if( yaw == 0.0f )
		{
			return idRotation( id_vec3_origin, idVec3( -1.0f, 0.0f, 0.0f ), roll );
		}
		if( roll == 0.0f )
		{
			return idRotation( id_vec3_origin, idVec3( 0.0f, 0.0f, -1.0f ), yaw );
		}
	}
	else if( yaw == 0.0f && roll == 0.0f )
	{
		return idRotation( id_vec3_origin, idVec3( 0.0f, -1.0f, 0.0f ), pitch );
	}
	...
	return idRotation( id_vec3_origin, vec, angle );
}
