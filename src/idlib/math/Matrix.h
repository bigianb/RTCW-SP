...
inline float idMat2::Trace() const
{
...
inline int idMat2::GetDimension() const
{
	return 4;
}

inline const float* idMat2::ToFloatPtr() const
{
	return mat[0].ToFloatPtr();
}

inline float* idMat2::ToFloatPtr()
{
	return mat[0].ToFloatPtr();
}
...
inline void idMat3::Zero()
{
	memset( mat, 0, sizeof( idMat3 ) );
}

inline void idMat3::Identity()
{
	*this = mat3_identity;
}
...
inline bool idMat3::IsRotated() const
{
...
inline int idMat3::GetDimension() const
{
	return 9;
}

inline const float* idMat3::ToFloatPtr() const
{
	return mat[0].ToFloatPtr();
}

inline float* idMat3::ToFloatPtr()
{
	return mat[0].ToFloatPtr();
}
...
// jmarshall
inline idMat3 idMat4::ToMat3() const
{
	idMat3 m;
...
// RB begin
inline idVec3 idMat4::GetTranslation() const
{
	idVec3 pos;
...
inline void idMat4::Zero()
{
	memset( mat, 0, sizeof( idMat4 ) );
}

inline void idMat4::Identity()
{
	*this = mat4_identity;
}
...
inline int idMat4::GetDimension() const
{
	return 16;
}

inline const float* idMat4::ToFloatPtr() const
{
	return mat[0].ToFloatPtr();
}

inline float* idMat4::ToFloatPtr()
{
	return mat[0].ToFloatPtr();
}
...
inline void idMat5::Zero()
{
	memset( mat, 0, sizeof( idMat5 ) );
}

inline void idMat5::Identity()
{
	*this = mat5_identity;
}
...
inline int idMat5::GetDimension() const
{
	return 25;
}

inline const float* idMat5::ToFloatPtr() const
{
	return mat[0].ToFloatPtr();
}

inline float* idMat5::ToFloatPtr()
{
	return mat[0].ToFloatPtr();
}
...
inline void idMat6::Zero()
{
	memset( mat, 0, sizeof( idMat6 ) );
}

inline void idMat6::Identity()
{
	*this = mat6_identity;
}
...
inline int idMat6::GetDimension() const
{
	return 36;
}

inline const float* idMat6::ToFloatPtr() const
{
	return mat[0].ToFloatPtr();
}

inline float* idMat6::ToFloatPtr()
{
	return mat[0].ToFloatPtr();
}
