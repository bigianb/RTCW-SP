...
inline idPlane::idPlane( const idVec3& v0, const idVec3& v1, const idVec3& v2, bool fixDegenerate )
{
...
inline int idPlane::GetDimension() const
{
	return 4;
}
...
inline float* idPlane::ToFloatPtr()
{
