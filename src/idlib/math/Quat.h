...
inline idQuat idQuat::Inverse() const
{
	return idQuat( -x, -y, -z, w );
}
...
inline int idQuat::GetDimension() const
{
	return 4;
}

inline const float* idQuat::ToFloatPtr() const
{
	return &x;
}

inline float* idQuat::ToFloatPtr()
{
	return &x;
}
...
inline int idCQuat::GetDimension() const
{
	return 3;
}
...
inline const float* idCQuat::ToFloatPtr() const
{
	return &x;
}

inline float* idCQuat::ToFloatPtr()
{
	return &x;
}
