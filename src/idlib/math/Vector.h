...
inline float idVec2::LengthSqr() const
{
	return ( x * x + y * y );
}
...
inline int idVec2::GetDimension() const
{
	return 2;
}

inline const float* idVec2::ToFloatPtr() const
{
	return &x;
}

inline float* idVec2::ToFloatPtr()
{
	return &x;
}

inline idVec2& operator/( float lhs, idVec2& rhs )
{
	rhs.x = lhs / rhs.x;
	rhs.y = lhs / rhs.y;
	return rhs;
...
extern idVec3 id_vec3_origin;
#define vec3_zero id_vec3_origin
...
inline int idVec3::GetDimension() const
{
	return 3;
}
...
inline idVec2& idVec3::ToVec2()
{
	return *reinterpret_cast<idVec2*>( this );
}

inline const float* idVec3::ToFloatPtr() const
{
	return &x;
}
...
inline idVec3& operator/( float lhs, idVec3& rhs )
{
	rhs.x = rhs.x / lhs;
	rhs.y = rhs.y / lhs;
	rhs.z = rhs.z / lhs;
...
inline int idVec4::GetDimension() const
{
	return 4;
}
...
inline idVec3& idVec4::ToVec3()
{
	return *reinterpret_cast<idVec3*>( this );
}

inline const float* idVec4::ToFloatPtr() const
{
	return &x;
}

inline float* idVec4::ToFloatPtr()
{
	return &x;
}
...
inline int idVec5::GetDimension() const
{
	return 5;
}
...
inline idVec3& idVec5::ToVec3()
{
	return *reinterpret_cast<idVec3*>( this );
}

inline const float* idVec5::ToFloatPtr() const
{
	return &x;
}

inline float* idVec5::ToFloatPtr()
{
	return &x;
}
...
inline int idVec6::GetDimension() const
{
	return 6;
}
...
inline const float* idVec6::ToFloatPtr() const
{
	return p;
}

inline float* idVec6::ToFloatPtr()
{
	return p;
}
